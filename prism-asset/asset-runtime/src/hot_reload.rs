...
mod tests {
    ...
    fn polling_detects_modification() {
        ...
        let mut builder = asset_package::PackageBuilder::new();
        let id = asset_core::AssetId::from_raw((1u64 << 32) | 1);
        builder.add_asset(id, asset_core::AssetType::Binary, b"v1".to_vec(), &[]);
        ...
        // Modify the file.
        let mut builder2 = asset_package::PackageBuilder::new();
        builder2.add_asset(id, asset_core::AssetType::Binary, b"v2".to_vec(), &[]);
