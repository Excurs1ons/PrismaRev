...
fn main() -> Result<()> {
    ...
    mod_rs.push_str("// DO NOT EDIT. Regenerate: `cd xtask && cargo run --bin shader-bindgen -- \\\n");
    mod_rs.push_str("//   ../shaders/reflection ../crates/prism-render/src/shader_bindings`\n");
